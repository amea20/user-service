...
<title>ProjectTracker - Add project</title>
<!--Start of container-->
<div id="container">
...
<div class="col-sm-3"><form:input type="text" id="datepicker" path="targetDate" class="form-control" ></form:input><span class="add-on"><i class="icon-th"></i></span></div>
</div>
<div class="form-group">
...
<div class="form-group"><button id="addproject" class="btn btn-default" type="submit">Add project</button></div>
</form:form>
</div>
<!--End of container-->
